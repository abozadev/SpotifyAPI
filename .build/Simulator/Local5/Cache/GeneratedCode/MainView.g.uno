...
public partial class MainView: Fuse.App
{
    ...
    public partial class Factory: Uno.UX.IFactory
    {
        ...
        public object New()
        {
            ...
            var temp = new Fuse.Reactive.DataBinding<string>(self_Value_inst, "album.name");
    ...
    public partial class Factory1: Uno.UX.IFactory
    {
        ...
        public object New()
        {
            ...
            self_Value_inst = new MainView.Fuse_Controls_TextControl_string_Value_Property(self);
            var temp = new Fuse.Reactive.DataBinding<string>(self_Value_inst, "artists.name");
            self.Behaviors.Add(temp);
            return self;
        }
    }
    ...
    internal void InitializeUX()
    {
        ...
        var temp14 = new Factory2(this);
        var temp15 = new Fuse.Reactive.DataBinding<object>(temp_Items_inst, "tracks.items");
